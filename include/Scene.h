...
public:
  ...
  void standardScene() {
    add(Tetrahedron(glm::vec3(4.0f, -4.2f, -2.0f), 2.0f, 2.0f,
                    Material(diffusion, AQUA)));

    add(Tetrahedron(glm::vec3(8.0f, -3.0f, -2.0f), 2.0f, 4.0f));

    // add(new Sphere(glm::vec3(5.2f, -3.0f, 0.0f), 1.0f,
    // Material(translucence, WHITE)));

    add(new Sphere(glm::vec3(7.0f, 3.0f, -2.0f), 2.0f,
                   Material(specularity, WHITE)));

    add(new Sphere(glm::vec3(6.0f, -4.0f, 1.0f), 1.0f,
                   Material(translucence, WHITE)));

    add(new Sphere(glm::vec3(7.0f, -0.1f, -2.0f), 1.0f,
                   Material(glossy, AQUA)));

    add(new Sphere(glm::vec3(8.6f, 3.6f, 1.5f), 1.0f, Material(glossy, WHITE)));
