...
public:
	...
	Scene( Camera c = Camera(glm::vec3(-1.0f, 0.0f, 0.0f), 400), std::vector<Object*> o = std::vector<Object*>()) : Objects{ o }, camera{c} {
        standardScene();
    ...
    void standardScene() {
        ...
        Objects.push_back(new Triangle(points[0], points[6], points[7], Material(Material::diffusion, ColorDBL(0.5, 0.0, 0.0)) ));
        
        // Wall 2
        Objects.push_back(new Triangle(points[1], points[7], points[2], Material(Material::diffusion, ColorDBL(0.0, 0.5, 0.1))));
        Objects.push_back(new Triangle(points[2], points[7], points[8], Material(Material::diffusion, ColorDBL(0.0, 0.5, 0.1)) ));

        // Wall 3
        Objects.push_back(new Triangle(points[2], points[8], points[3], Material(Material::diffusion, ColorDBL(0.0, 0.0, 0.5))));
        Objects.push_back(new Triangle(points[3], points[8], points[9], Material(Material::diffusion, ColorDBL(0.0, 0.0, 0.5))));
        ...
        Objects.push_back(new Triangle(points[4], points[9], points[10], Material(Material::diffusion, ColorDBL(0.5, 0.0, 0.3))));

        // Roof 2
        Objects.push_back(new Triangle(points[0], points[1], points[4], Material(Material::diffusion, ColorDBL(0.1, 0.0, 0.2))));
        Objects.push_back(new Triangle(points[1], points[3], points[4], Material(Material::diffusion, ColorDBL(0.1, 0.0, 0.2))));

        // Roof 3
        Objects.push_back(new Triangle(points[10], points[4], points[5], Material(Material::diffusion, ColorDBL(0.1, 0.0, 0.2))));

        // Wall 5
        Objects.push_back(new Triangle(points[4], points[10], points[5], Material(Material::diffusion, ColorDBL(0.0, 0.0, 0.5))));
        Objects.push_back(new Triangle(points[5], points[10], points[11], Material(Material::diffusion, ColorDBL(0.0, 0.0, 0.5))));

        // Wall 6
        Objects.push_back(new Triangle(points[0], points[5], points[11], Material(Material::diffusion, ColorDBL(0.0, 0.8, 0.2))));
        Objects.push_back(new Triangle(points[0], points[11], points[6], Material(Material::diffusion, ColorDBL(0.0, 0.8, 0.2))));

        // Floor 1
        Objects.push_back(new Triangle(points[7], points[9], points[8], Material(Material::diffusion, ColorDBL(0.2, 0.2, 0.4))));

        // Floor 2      
        Objects.push_back(new Triangle(points[7], points[10], points[9], Material(Material::diffusion, ColorDBL(0.2, 0.2, 0.4))));
        Objects.push_back(new Triangle(points[7], points[6], points[10], Material(Material::diffusion, ColorDBL(0.2, 0.2, 0.4))));

        // Floor 3
        Objects.push_back(new Triangle(points[6], points[11], points[10], Material(Material::diffusion, ColorDBL(0.2, 0.2, 0.4))));
