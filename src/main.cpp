...
int main()
{
    ...
    Triangle* myTriangle = new Triangle(glm::vec3(10.0f, 0.0f, 0.0f), glm::vec3(10.0f, -1.0f, 1.0f), glm::vec3(10.0f, 0.0f, 1.0f));
    Camera c = Camera(glm::vec3(-1.0f, 0.0f, 0.0f), 800);
